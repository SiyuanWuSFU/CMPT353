...
def main():
    ...
    bayes_convert_model = make_pipeline(FunctionTransformer(Transform,validate = True),GaussianNB())

    knn_rgb_model = KNeighborsClassifier(n_neighbors = 8)

    knn_convert_model = make_pipeline(FunctionTransformer(Transform,validate = True),KNeighborsClassifier(n_neighbors = 8))

    rf_rgb_model = DecisionTreeClassifier(max_depth = 9)

    rf_convert_model = make_pipeline(FunctionTransformer(Transform,validate = True),DecisionTreeClassifier(max_depth = 9))
    #models = [bayes_rgb_model, bayes_convert_model,knn_rgb_model,knn_convert_model]
